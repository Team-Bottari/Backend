...
class Images:
    @posting_images_router.post(POSTING_IMAGES_URL+"/{posting_id}/{image_id}/upload")
    async def create_image(self,background_task:BackgroundTasks,posting_id:str=None,image_id:str=None,upload_file:UploadFile=File(...)):
        ...
        return {"response":200}
    @posting_images_router.post(POSTING_IMAGES_URL+"/{posting_id}/{image_id}/mini")
    ...
    @posting_images_router.post(POSTING_IMAGES_URL+"/{posting_id}/{image_id}/standard")
    async def read_standard_image(self,background_task:BackgroundTasks,posting_id:str,image_id:str):
        ...
        return FileResponse(path)
    @posting_images_router.post(POSTING_IMAGES_URL+"/{posting_id}/{image_id}/origin")
    async def read_origin_image(self,posting_id:str,image_id:str):
        path = get_specific_path(posting_id,image_id,tag="origin")
        return FileResponse(path)
    @posting_images_router.post(POSTING_IMAGES_URL+"/{posting_id}/{image_id}/update")
